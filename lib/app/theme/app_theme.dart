  ...
  static ThemeData get lightTheme {
    return ThemeData(
      colorScheme: ColorScheme.light(
          primary: ColorResource.primaryColor,      // SELECTED DATE BACKGROUND (circle)
      ...
      inputDecorationTheme: InputDecorationTheme(
        ...
        focusedBorder: OutlineInputBorder(
          borderRadius: BorderRadius.circular(12),
          borderSide: const BorderSide(color: ColorResource.primaryColor, width: 1.5),
        ),
      ...
      datePickerTheme: DatePickerThemeData(
        ...
        todayBorder: BorderSide(color: ColorResource.primaryColor),
      ),
